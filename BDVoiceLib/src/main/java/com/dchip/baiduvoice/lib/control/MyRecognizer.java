package com.dchip.baiduvoice.lib.control;
...
import com.dchip.baiduvoice.lib.recognization.IRecogListener;
import com.dchip.baiduvoice.lib.recognization.RecogEventAdapter;
...
public class MyRecognizer {
    ...
    public void start(Map<String, Object> params) {
        String json = new JSONObject(params).toString();
        Log.i(TAG + ".Debug", "asr params(反馈请带上此行日志):" + json);
